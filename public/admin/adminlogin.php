...
<h3 class="bg-secondary text-center text-white">Placid College Admin </h3>

</header> 

 <div id="login_main " class="mt-4">

<h5 class="ml-4">Staff Login</h5>
 ...
 <?php echo  output_message($message); ?>
   ...
   <div class="w-50 bg-white ml-4">      
   <form class="form-group w-75 ml-3" >
  <div>
